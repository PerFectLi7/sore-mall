...
UserService {
    ...
    @HttpMethod(description = "获取用户openId")
    public UserDTO getOpenId(
            @HttpParam(name = "nickName", type = HttpParamType.COMMON, description = "用户昵称") String nickName,
            @HttpParam(name = "avatarUrl", type = HttpParamType.COMMON, description = "用户头像") String avatarUrl,
            @HttpParam(name = "sex", type = HttpParamType.COMMON, description = "用户性别") Integer sex,
            @HttpParam(name = "shareUserId", type = HttpParamType.COMMON, description = "用户分享ID") Long shareUserId,
            @HttpParam(name = "raw", type = HttpParamType.COMMON, description = "登录时获取的code") String raw) throws ServiceException, IOException;
